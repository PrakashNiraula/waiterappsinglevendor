...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final bool showCart;
  CustomAppBar({this.isBackButtonExist = true, required this.onBackPressed, this.showCart = false});
        ...
        child: AppBar(
          ...
          leading: isBackButtonExist ? Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(
                  color: Colors.black.withOpacity(0.10), offset: Offset(0, 4.44), blurRadius: 4.44, spreadRadius: 0,
                )],
              ),
              child: InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.arrow_back_ios, color: Theme.of(context).textTheme.bodyText1?.color),
                    SizedBox(width: 8.0),
                  ],
                ),
              ),
          ...
          actions: showCart ? [
            IconButton(onPressed: (){
              Get.to(()=> CartScreen(), transition: Transition.leftToRight, duration: Duration(milliseconds: 300));
            },
  ...
  @override
  Size get preferredSize => Size(Dimensions.WEB_MAX_WIDTH, ResponsiveHelper.isTab(Get.context) ? 70 : 60);
}
