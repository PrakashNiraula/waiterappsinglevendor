...
class AppConstants {
  static const String APP_NAME = 'WaiterApp';
  static const double APP_VERSION = 1.1;
  // demo
  static const String BASE_URL = 'https://www.21stcollection.com/restaurant';
  ...
  static const String ORDER_LIST = '/api/v1/table/order/list?branch_table_token=';
  // Shared Key
